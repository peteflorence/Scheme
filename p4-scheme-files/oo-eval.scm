...
(define (making-a-class-are-we? expr) (tagged-list? expr 'make-class))  ;; === PROBLEM 2 ===
...
(define (oo-eval exp env)
  (cond ((self-evaluating? exp) exp)
        ((making-a-class-are-we? exp) (eval-make-class exp env)) ;; === PROBLEM 2 ===
...
;; PROBLEM 4
(define (oo-apply-instance instance arguments)                                                                                        ;; HERE NOW!!!!
  (newline)
  (newline)
  (newline)
  (newline)
